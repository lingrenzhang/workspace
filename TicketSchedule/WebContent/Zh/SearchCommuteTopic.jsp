...
function search(rid)
{
	...
	{
		queryURL = "/TicketSchedule/SearchCommuteTopics";
	}
	else if(rid == -1) // -1 for user specified
	{
		queryURL = "/TicketSchedule/SearchCommuteTopics"+"?"+$('#geoinfo').serialize();
	}
	else
	{
		queryURL = "/TicketSchedule/SearchCommuteTopics?rid="+rid;
	}
