...
public class UserAccess {
		...
		public void insertValue(String userName,int groupId, String password,String givenname, String surname,String address,int userLevel,String avatarID,String cellphone) throws Exception
		{
			...
			try
			{
				...
				sql.execute("insert into user (emailAddress,groupid,password,givenname,surname,address,userLevel,avatarID,cellphone) values(\"" 
						+ userName + "\","
						+ groupId + ",\""
						+ password + "\",\""
						+ givenname + "\",\""
        ...
        public ResultSet selectByName(String name, boolean batch)
        {
        	...
        	try
        	{
				...
				String query = "select * from user where emailAddress=\""+name+"\"";
				result = sql.executeQuery(query);
        	}
			catch (java.lang.ClassNotFoundException e){
				System.err.println("ClassNotFoundException:"+e.getMessage());
        ...
        public int getIDbyName(String name) 
        {
        	...
        	try
        	{
				...
				sql=objConn.createStatement();
	        	String query = "select userid from user where givenname= '"+name+"'";
        ...
        public int deleteUser(IUserInfo user)
        {
        	...
        	try
        	{
				...
				sql=objConn.createStatement();
	        	String query = "delete from user where userid= '"+user.get_uid()+"'";
		...
		public static int insertUser(UserProfile user) {
			...
			try
			{
				...
				sql=objConn.createStatement();
				sql.execute("insert into user (emailAddress,password,givenname,surname,address,userLevel,avatarID,cellphone) values(\"" 
						+ user._emailAddress + "\",\""
						+ user._password + "\",\""
						+ user._givenname + "\",\""
						+ user._surename + "\",\""
        ...
        public static int updateUserProfile(UserProfile user)
        {
        	...
        	try
			{
				...
				sql=objConn.createStatement();
				rows=sql.executeUpdate("update user set "
        ...
        public static boolean verifyPassword(int uid,String password)
        {
        	...
        	try
			{
				...
				getConnection();
				sql=objConn.createStatement();
				ResultSet rs = sql.executeQuery("select password from user where userId="+uid);
				rs.next();
        ...
        public static boolean verifyPassword(String userName,String password)
        {
        	...
        	try
			{
				...
				getConnection();
				sql=objConn.createStatement();
				ResultSet rs = sql.executeQuery("select password from user where userName="+userName);
			    String realpass= rs.getString("password");
			    rs.next();
			    if (realpass.equals(password)){
			    	result=true;
